...
mkdir -p .tmp/kaplansky_idempotent_conjecture
cp artifacts/stitch_constants.json .tmp/kaplansky_idempotent_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/kaplansky_idempotent_conjecture/constants_registry.json
