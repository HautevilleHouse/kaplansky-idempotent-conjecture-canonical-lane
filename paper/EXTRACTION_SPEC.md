# Constant Extraction Spec (KID)
    ...
    ## Formula Set
    - `kappa_algebra_raw = c_algebra_raw * algebra_density_raw - e_algebra_raw`
- `sigma_trace_raw = trace_floor_raw - coefficient_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `idempotent_transfer_raw = c_idemp_raw * transfer_gain_raw - e_idemp_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_algebra`, `sigma_trace`, `kappa_compact`, `rho_rigidity`, `idempotent_transfer`, `sigma_star_can`
    ...
    3. `scripts/kid_closure_guard.py`
